...
// import 'package:guident_admin/model/school_session_model.dart';
...
/*class UserService {
  Future<SchoolDetailModel> getSchool() async {
    ...
    final response = await NetworkService.sendRequest(
      ...
      token: token!,
      url: '${StaticValues.baseUrl}get_school/$schoolId',
    );
    log(response!.body);
  ...
  Future<dynamic> getSessionClasses() async {
    ...
    final response = await NetworkService.sendRequest(
      requestType: RequestType.get,
      token: token!,
      url: '${StaticValues.baseUrl}get_school_academic_sessions?school_id=$schoolId',
    );
    log(response!.body);
    return await NetworkHelper.filterResponse(
        callBack: (json) {
